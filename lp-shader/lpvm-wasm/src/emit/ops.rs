...
pub(crate) fn emit_op(
    ...
    match op {
        ...
        LpirOp::Fadd { dst, lhs, rhs } => match fm {
            FloatMode::Q32 => q32::emit_q32_fadd_wrap(sink, lhs.0, rhs.0, dst.0),
            FloatMode::F32 => {
                sink.local_get(lhs.0)
                    .local_get(rhs.0)
                    .f32_add()
        ...
        LpirOp::Fsub { dst, lhs, rhs } => match fm {
            FloatMode::Q32 => q32::emit_q32_fsub_wrap(sink, lhs.0, rhs.0, dst.0),
            FloatMode::F32 => {
                sink.local_get(lhs.0)
                    .local_get(rhs.0)
                    .f32_sub()
        ...
        LpirOp::Fmul { dst, lhs, rhs } => match fm {
            FloatMode::Q32 => q32::emit_q32_fmul_wrap(sink, lhs.0, rhs.0, dst.0),
            FloatMode::F32 => {
                sink.local_get(lhs.0)
                    .local_get(rhs.0)
                    .f32_mul()
