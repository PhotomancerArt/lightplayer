...
fn guest_pointer_out_plan(fn_name: &str) -> Option<Vec<(usize, usize, &'static str)>> {
    match fn_name {
        ...
        "__lp_lpfn_oklab2rgb_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfn_oklab2rgb_q32" => Some(vec![(0, 3, "i32")]),
        "__lp_lpfn_oklch2rgb_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfn_oklch2rgb_q32" => Some(vec![(0, 3, "i32")]),
        "__lp_lpfn_rgb2oklab_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfn_rgb2oklab_q32" => Some(vec![(0, 3, "i32")]),
        "__lp_lpfn_rgb2oklch_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfn_rgb2oklch_q32" => Some(vec![(0, 3, "i32")]),
