...
pub fn parse_lps_value_literal(literal_str: &str) -> Result<LpsValueF32, GlslError> {
    ...
    let wrappers = [
        format!("int probe() {{ return {literal_str}; }}"),
        format!("uint probe() {{ return {literal_str}; }}"),
        format!("float probe() {{ return {literal_str}; }}"),
        format!("bool probe() {{ return {literal_str}; }}"),
        format!("vec2 probe() {{ return {literal_str}; }}"),
        format!("vec3 probe() {{ return {literal_str}; }}"),
        format!("vec4 probe() {{ return {literal_str}; }}"),
        format!("ivec2 probe() {{ return {literal_str}; }}"),
        format!("ivec3 probe() {{ return {literal_str}; }}"),
        format!("ivec4 probe() {{ return {literal_str}; }}"),
        format!("uvec2 probe() {{ return {literal_str}; }}"),
        format!("uvec3 probe() {{ return {literal_str}; }}"),
        format!("uvec4 probe() {{ return {literal_str}; }}"),
        format!("bvec2 probe() {{ return {literal_str}; }}"),
        format!("bvec3 probe() {{ return {literal_str}; }}"),
        format!("bvec4 probe() {{ return {literal_str}; }}"),
        format!("mat2 probe() {{ return {literal_str}; }}"),
        format!("mat3 probe() {{ return {literal_str}; }}"),
        format!("mat4 probe() {{ return {literal_str}; }}"),
    ];
