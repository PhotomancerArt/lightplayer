//! Native f32 `exp2` — the f32 sibling of [`super::exp2_q32`].
//!
//! **Implementation:** `libm::exp2f`. `libm` is a `no_std` workspace
...
//!
//! **Domain:** Exact on integer arguments in range.

/// GLSL `exp2(x)`.
#[unsafe(no_mangle)]
pub extern "C" fn __lps_exp2_f32(x: f32) -> f32 {
    libm::exp2f(x)
}
