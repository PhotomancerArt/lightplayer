...
pub extern "C" fn __lp_lpfn_rgb2hsv_f32(result_ptr: *mut f32, x: f32, y: f32, z: f32) {
    ...
    unimplemented!(
        "__lp_lpfn_rgb2hsv_f32: native f32 builtins are not implemented (f32 roadmap M5)"
    )
}
...
pub extern "C" fn __lp_lpfn_rgb2hsv_vec4_f32(result_ptr: *mut f32, x: f32, y: f32, z: f32, w: f32) {
    ...
    unimplemented!(
        "__lp_lpfn_rgb2hsv_vec4_f32: native f32 builtins are not implemented (f32 roadmap M5)"
    )
}
