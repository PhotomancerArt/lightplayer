...
#
#   scripts/emu/build-reference-image.sh <features> [<commit>=d6cfaa205] [<spike>=e8d64eeff|none]
...
features="${1:?usage: build-reference-image.sh <features> [<commit>] [<spike>|none]}"
commit="${2:-d6cfaa205}"
spike="${3:-e8d64eeff}"
