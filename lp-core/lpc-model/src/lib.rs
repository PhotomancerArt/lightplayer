...
pub use nodes::{
    ...
    MappingConfig, ModuleDef, ModuleDefView, NodeDefParseError, NodeStarter, OutputDef,
    ...
    node_def_asset_ref, resolve_artifact_specifier, set_node_def_asset_ref, shader_panel_step,
...
pub use slot::{
    ...
    SlotRecordAccess, SlotRecordAccessMut, SlotRecordMutAccess, SlotRecordShape, SlotRef, SlotRole,
    SlotRoleResolution, SlotSemantics, SlotShape, SlotShapeEntry, SlotShapeId, SlotShapeIdError,
    SlotShapeLookup, SlotShapeRegistry, SlotShapeRegistryError, SlotShapeRegistrySnapshot,
    SlotShapeView, SlotValueAccess, SlotValueMut, SlotValueMutAccess, SlotValueShapeView,
    SlotVariantShape, SlotVariantShapeView, SlottedEnum, SlottedEnumMut, StaticLpType,
    StaticModelEnumVariant, StaticModelStructMember, StaticSlotAccess, StaticSlotEnumEncoding,
    StaticSlotEnumOption, StaticSlotFieldShape, StaticSlotMeta, StaticSlotShape,
    StaticSlotShapeDescriptor, StaticSlotValueShape, StaticSlotVariantShape, StaticValueEditorHint,
    ValueRef, ValueSlot, create_dynamic_slot_data, ensure_slot_present,
    insert_slot_map_entry_default, lookup_slot_data, lookup_slot_data_and_shape,
    lookup_slot_data_mut, lp_value_matches_type, remove_slot_map_entry, resolve_slot_role,
