...
const GOLDEN: &[Expectation] = &[
    ...
    // to match the real dome (40 suspended triangle panels + chevron doors,
    // generated by `cargo run -p lpt-geodome` — lamp POSITIONS moved, so
    // sampled bytes moved; counts, patch files and scatter placements are
    // pinned unchanged by `mini_dome_scatter`).
        ...
        outputs: &[
            (
                ...
                &[
                    ...
                    (648, 0xab0a1d7c113922a0, [56, 125, 179, 72, 206, 26]),
                    (648, 0x5ebb5559255497c9, [128, 123, 177, 71, 105, 26]),
                    (648, 0x3530d6f6003bfb77, [198, 121, 173, 70, 4, 26]),
                ],
            ),
            (
                ...
                &[
                    ...
                    (414, 0x0468db95cf3a1717, [83, 34, 248, 28, 208, 26]),
                    (414, 0xfad916858d8f4626, [55, 34, 242, 28, 224, 26]),
                    (414, 0x498f159452b2d1c1, [27, 34, 236, 28, 240, 26]),
                ],
            ),
        ],
    },
