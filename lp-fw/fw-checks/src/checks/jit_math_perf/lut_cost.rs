...
pub fn run(read_cycles: fn() -> u32) {
    log::info!("[jit-math-perf] --- LUT access cost ---");
    bench_rodata(
        "lut/rodata-seq-256",
        &TABLE_256,
    ...
    bench_rodata(
        "lut/rodata-stride-256",
        &TABLE_256,
        AccessPattern::Stride,
        read_cycles,
    );
    bench_rodata(
        "lut/rodata-random-256",
        &TABLE_256,
    ...
    bench_rodata(
        "lut/rodata-stride-512",
        &TABLE_512,
        AccessPattern::Stride,
        read_cycles,
    );
    bench_rodata(
        "lut/rodata-random-512",
        &TABLE_512,
        AccessPattern::Random,
        read_cycles,
    );
    ...
    bench_rodata(
        "lut/rodata-stride-1024",
        &TABLE_1024,
        AccessPattern::Stride,
        read_cycles,
    );
    bench_rodata(
        "lut/rodata-random-1024",
        &TABLE_1024,
        AccessPattern::Random,
        read_cycles,
    );
    ...
    bench_rodata(
        "lut/rodata-stride-2048",
        &TABLE_2048,
        AccessPattern::Stride,
        read_cycles,
    );
    bench_rodata(
        "lut/rodata-random-2048",
        &TABLE_2048,
        AccessPattern::Random,
        read_cycles,
    );
...
fn bench_ram(label: &str, source: &[i32], pattern: AccessPattern, read_cycles: fn() -> u32) {
