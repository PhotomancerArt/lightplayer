...
| [`fw-esp32v3`](./fw-esp32v3/) | classic ESP32 bare metal (Xtensa LX6) | Third chip — the WLED-class deployment target (4 MB flash, C6-shaped partition table). Boot + RAM-probe stage today; grows the server/JIT app layer per the classic bring-up roadmap. Desk board: DOM-Z-102. |
