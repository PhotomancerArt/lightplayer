...
| phone | harness, boot-idle-memfs | — | **NEVER MEASURED** | — | — | — | the rig now defines the rows (translator-quality P1); lab `j-20260913-1702-102a` is queued on `c66d8ac` and the phone has not joined it |
...
translator-quality P1 and `j-20260913-1702-102a` is queued; until presses land,
