...
- Radio transport decision (keep ESP-NOW+WiFi vs. 802.15.4) paired with the
  ...
  untouched** (+359,616 B, headroom 324,320 B; see the ledger). Radio day is
  still owed for WiFi/TLS, and it now starts from ~324 KB, not ~686 KB: the
