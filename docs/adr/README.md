...
| Editing individual instances of a live repeat (per-instance overrides without expanding) — flagged at the 2026-08-05 G2 gate as the big ask | `2026-08-05-map2d-format-2-repeat-and-gaps` | The mapping-editor follow-up plan (view/edit split round) |
