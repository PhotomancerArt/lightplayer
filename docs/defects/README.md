...
| --- | --- | --- | --- | --- |
| assumed-context | 2026-09-23 | [five-wires-reads-a-report-still-on-the-uart-as-a-lost-one](2026-09-23-five-wires-reads-a-report-still-on-the-uart-as-a-lost-one.md) | **open** | lp-emu-esp32v3 tests/five_wires.rs: the "no summary line lost" bound assumes every report is on the wire at the 10 s deadline; on the #794-over-lean-wire image the deadline lands 2 frames after frame 1980 with its five report lines still draining UART0 at 921,600 baud, and the test fails with nothing lost |
