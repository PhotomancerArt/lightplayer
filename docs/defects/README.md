...
| unenforced-test-precondition | 2026-09-08 | [usb-gates-pin-a-heartbeat-millisecond](2026-09-08-usb-gates-pin-a-heartbeat-millisecond.md) | **open** (recorded, not diagnosed) | lp-emu-esp32c6 `tests/usb_control.rs` G3-1/G3-1b: an exact `"uptime_ms":5000` pins a millisecond the firmware's loop only samples by luck |
