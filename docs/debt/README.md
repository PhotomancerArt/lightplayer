...
| [two-green-prs-can-red-main](two-green-prs-can-red-main.md) | paying-down | 2026-08-02 | CI / merge policy | CI never builds the merge result, so two PRs touching opposite sides of an interface both pass and main breaks; cost is misattributed blame — since 2026-09-24 a red main push names the PRs merged since the last green main (`red-main-suspects` job); retire once a real incident is diagnosed from it |
