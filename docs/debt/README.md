...
| [safe-mode-dim-boot-unproven](safe-mode-dim-boot-unproven.md) | carried | 2026-08-01 | fw-esp32c6/bootctl + lpc-engine safe clamp | the arm chain is flash-verified but no board has ever been seen booting dim; the recovery payload is unproven end to end |
