...
| [s3-frame-cost-scales-per-fixture](s3-frame-cost-scales-per-fixture.md) | carried | 2026-07-31 | lpc-engine fixture/shader render path | S3 frame cost scales ~8.4 ms per fixture (render/sampling, 70% of a 4-fixture frame); RMT sends measured at 11% and exonerated |
