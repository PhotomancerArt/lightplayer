...
/// [`SettingsStore`](super::SettingsStore), no async work. Every user
/// mutation is normalized in the store (trimmed; empty ⇒ clear) and
/// re-persists the user layer through the controller's `on_user_settings`
/// hook.
#[derive(Clone, Debug)]
