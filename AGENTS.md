...
last three counted presses are within 5 %); **leave it off for a number that
decides something** — the control row flattens before the translated row
does, and the README has the measured cost.
